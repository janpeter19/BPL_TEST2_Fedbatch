# Setup application functions BPL_TEST2_Fedbatch, dependent on previous import of functions 
# from fmu_explore
...
def newplot(title="Fedbatch cultivation", plotType="TimeSeries"):
    ...
    # Plot diagram
        ...
        diagrams.append(
            "ax2.plot(t,sim_res['bioreactor.c[1]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax3.plot(t,sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax4.plot(t,sim_res['bioreactor.V'],color='b',linestyle=linetype)"
        )
    ...
    # Plot diagram
        ...
        diagrams.append(
            "ax31.plot(t,sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax41.plot(t,sim_res['bioreactor.V'],color='b',linestyle=linetype)"
        )
        diagrams.append(
