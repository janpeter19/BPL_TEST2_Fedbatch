...
def newplot(title='Fedbatch cultivation', plotType='TimeSeries'):
   ...
   if plotType == 'TimeSeries':
      ...
      diagrams.append("ax[1].plot(sim_res['time'],sim_res['bioreactor.culture.q[1]'],color='r',linestyle=linetype)")   
      diagrams.append("ax[2].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)")  
      diagrams.append("ax[3].plot(sim_res['time'],sim_res['bioreactor.V'],color='b',linestyle=linetype)")  
   ...
   # Plot diagram 
      ...
      diagrams.clear()
      diagrams.append("ax[0].plot(sim_res['time'],sim_res['bioreactor.c[2]'],color='b',linestyle=linetype)")
      diagrams.append("ax[1].plot(sim_res['time'],sim_res['bioreactor.c[1]'],color='b',linestyle=linetype)")     
      diagrams.append("ax[2].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)")  
      diagrams.append("ax[3].plot(sim_res['time'],sim_res['bioreactor.V'],color='b',linestyle=linetype)")  
